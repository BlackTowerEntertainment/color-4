...
THREE.MD2CharacterComplex = function () {
    ...
    function createPart( geometry, skinMap ) {
        ...
        var materialWireframe = new THREE.MeshPhongMaterial( { color: 0xffaa00, specular: 0x000000, shininess: 0, wireframe: true, shading: THREE.SmoothShading, map: whiteMap, morphTargets: true, morphNormals: true, metal: true } );

        var materialTexture = new THREE.MeshPhongMaterial( { color: 0xffffff, specular: 0x00000, shininess: 0, wireframe: false, shading: THREE.SmoothShading, map: skinMap, morphTargets: true, morphNormals: true, metal: true } );
